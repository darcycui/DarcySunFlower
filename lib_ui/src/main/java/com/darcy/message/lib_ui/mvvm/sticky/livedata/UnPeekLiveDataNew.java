...
/**
 * UnPeekLiveData 的升级版 去除map 改用版本号控制是否消费
 *
 ...
 */
public class UnPeekLiveDataNew<T> extends MutableLiveData<T> {

    public UnPeekLiveDataNew(T value) {
        super(value);
    }

    public UnPeekLiveDataNew() {
        super();
    }
