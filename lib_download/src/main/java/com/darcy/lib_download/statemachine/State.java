...
public class State implements IState {
    ...
    /* (non-Javadoc)
     * @see com.darcy.lib_download.statemachine.IState#enter()
     */
    @Override
    public void enter() {
    }
    ...
    /* (non-Javadoc)
     * @see com.darcy.lib_download.statemachine.IState#exit()
     */
    @Override
    public void exit() {
    }
    ...
    /* (non-Javadoc)
     * @see com.darcy.lib_download.statemachine.IState#processMessage(android.os.Message)
     */
    @Override
